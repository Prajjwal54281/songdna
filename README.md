...
**Honest limitation, found by actually testing this**: the tempo estimator is naive, with no phase
...
It provisions Postgres and the API from one file, reusing the same Dockerfile as local Docker
